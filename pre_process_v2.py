...
def process_train_data(params):
    ...
    save_train_data(file_names, labels, params)
...
def save_train_data(filenames, labels, params):
...
def process_test_data():
    ...
    save_test_data(file_names)


def save_test_data(file_names):
...
if __name__ == '__main__':
    ...
    logging.info('Remove previous files up...')
    shutil.rmtree('data')
